...
echo "<b>Enter a name for search.
      <br>In here you can change your post name and post description, cannot update a photo.<br>
...
return $raw_results;
      ...
      $query = $_POST['query'];
      $raw_results = mysql_query("SELECT * FROM post_text_and_image WHERE post_name = '$query' ") ;
...
if(isset($_POST["edit"]))
{
  ...
  $sql = "UPDATE post_text_and_image SET post_name = '$edit_posttext_name', image_text = '$edit_posttext' WHERE id = '{$_SESSION['post_id']}' ";
...
{
  $sql = "DELETE FROM post_text_and_image WHERE id = '{$_SESSION['post_id']}' ";
