	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6 text-justify">
				<h4><b>Publih your post</b></h4>
				<?php include 'posttext_form.php'; ?>
				<h4><b>View your post</b></h4>
				<?php include 'posttext_display.php'; ?>	
			</div>
			
			<div class="col-sm-6 text-justify">
				<h4><b>Search/Edit/Delete your post</b></h4>
				<?php include 'posttext_edit.php'; ?>
				<br><br>
			</div>	
		</div>
