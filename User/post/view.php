	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4 text-justify">
				...
				<a href="http://localhost/project/Blog/User/post/view_posttext.php"><button class="button" style="background-color: transparent; border-color: black; width: 100px; height: 50px; color: white;" type="button">Watch</button></a>
			</div>
			<div class="col-md-4 text-justify">
				<h3>Image with Text</h3>
				<hr>
				<h5>In here you can watched post which are just text.</h5>
				<a href="http://localhost/project/Blog/User/post/view_post_text_image.php"><button class="button" style="background-color: transparent; border-color: black; width: 100px; height: 50px; color: white;" type="button">Watch</button></a>
			</div>
			<div class="col-md-4 text-justify">
				<h3>Quote Image</h3>
				<hr>
				<h5>In here you can watched post which are just text.</h5>
				<a href="http://localhost/project/Blog/User/post/view_post_image.php"><button class="button" style="background-color: transparent; border-color: black; width: 100px; height: 50px; color: white;" type="button">Watch</button></a>
			</div>
		</div>	
		<div class="row">
			<br>
