...
<div class="row">
	...
	<div class="col-sm-4">
		...
		<input type="email" name="email" id="email" class="form-control" placeholder="Update Your Email"><br>
		<input type="text" name="address" id="address" class="form-control" placeholder="Update Your Address"><br>
		<input type="text" name="job" id="job" class="form-control" placeholder="Update Your Job"><br>
		<input type="text" name="tele_num" id="tele_num" class="form-control" placeholder="Update Your Mobile Number"><br>
	</div>
	<div class="col-sm-4">
