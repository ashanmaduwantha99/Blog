	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 text-justify">
				<p>
					In this web site we , my hope is creating a creative minds with
					words. For that i have designing this structure for three type.
					Those are Text Posts, Text with matching Image Posts and Images which are including post insides.
					Anyone can write inside here for that you have to register here. Also
					anyone can read posts which are published the members of this site were published.
					So.. Hope you enjoy this.

					<h4>Write your Minds.!</h4>
				</p>
			</div>
		</div>	
	</div>
